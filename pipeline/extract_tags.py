...
def extract_profession_from_title(title: str) -> Optional[str]:
    ...
    mappings = {
        ...
        "creative": ["дизайнер", "художник", "музыкант", "писатель", "фотограф", "архитектор", "копирайтер", "лингвист"],
        "media": ["журналист", "блогер", "видеоблогер", "контент"],
        "hr": ["hr", "кадровик", "рекрутер", "управление персоналом"],
        "student": ["студент", "аспирант", "учащийся", "выпускник", "первокурсник", "первокурсниц"],
        "homemaker": ["домохозяйка", "в декрете", "мама в декрете", "мать в декрете", "мама троих", "мама двоих"],
        "entrepreneur": ["предприниматель", "владелец бизнеса", "владелица бизнеса", "самозанят", "ип "],

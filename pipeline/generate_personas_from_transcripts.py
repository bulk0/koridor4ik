...
### 1. ЗАГОЛОВОК ПРОФИЛЯ
Заголовок должен иметь структуру: **Имя Фамилия, краткая характеристика, возраст, город, профессия**

**Имя и фамилия:**
- Придумай запоминающееся имя и фамилию на русском языке
- Фамилия должна быть короткой (6-12 букв), "говорящей" — отражать ключевую черту или особенность персоны
- Допустимы неологизмы, игра слов, ирония
- ЗАПРЕЩЕНЫ: производные от "промпт/промт" (Промптов, Промтер и т.п.)

**Краткая характеристика (3-7 слов):**
- Отражает реальное поведение и образ жизни человека
- Фокусируйся на том, ЧТО человек делает, КАК использует технологии
- Избегай шаблонных фраз: "экономящий время", "гуглящий всё подряд"

**Возраст, город, профессия:**
- Бери из интервью, если есть. Если нет — не придумывай.

Примеры стиля:
- "Екатерина Ледова, Зам директора с тремя детьми-хоккеистами, 47 лет, Москва"
- "Ярослав Фактчек, Студент-историк, проверяющий нейросети, 20 лет, Екатеринбург"
- "Георгий Метаболь, преподаватель-биохакер, пишущий книгу с ChatGPT, 44 года, Сочи"
